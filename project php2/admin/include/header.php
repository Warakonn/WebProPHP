<header class="app-header fixed-top"><footer></footer>
            ...
            <div id="app-sidepanel" class="app-sidepanel">
                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    <div class="app-branding">
                        <a class="app-logo" href="../admin/"><span class="logo-text">CATALOG NIKE</span></a>
                    </div>
                    <!--//app-branding-->
                    ...
                    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                            <li class="nav-item">
                                ...
                                <a class="nav-link active" <?php  echo !isset($_GET['page']) && empty($_GET['page']) ? 'active' : '' ?>href="../admin/ ">
                                    <span class="nav-icon">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " <?php  echo isset($_GET['page']) && $_GET['page'] =='about' ? 'active' : '' ?>href="?page=about">
                                    ...
                                    <span class="nav-link-text">Manage information Staff</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <a class="nav-link" <?php  echo isset($_GET['page']) && $_GET['page'] =='product_type' ? 'active' : '' ?>href="?page=product_type">
                                    <span class="nav-icon">
                                        <!-- <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                fill-rule="evenodd"
                                    ...
                                    <span class="nav-link-text">Manage Product type</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                            <li class="nav-item">
